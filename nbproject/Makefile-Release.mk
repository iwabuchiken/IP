...
${OBJECTDIR}/img_lib.o: img_lib.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/img_lib.o img_lib.c
...
${OBJECTDIR}/pgmlib.o: pgmlib.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pgmlib.o pgmlib.c

${OBJECTDIR}/ppmlib.o: ppmlib.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ppmlib.o ppmlib.c
